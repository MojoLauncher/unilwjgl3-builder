...
if [[ "$LWJGL_VERSION" == "3.3.1" ]]; then
   ...
   apply_patch lwjgl3_3.3.1_replace_locale-sensitive_string_format "[3.3.1] fix crash on arabic locale by replacing locale-sensitive String.format"
fi
...
if [[ "$LWJGL_VERSION" == "3.2.3" ]]; then
   ...
   apply_patch lwjgl3_3.2.3_replace_locale-sensitive_string_format "[3.2.3] fix crash on arabic locale by replacing locale-sensitive String.format"
fi
